...
public class Preferences {
    ...
    public static void setAccout(String user,String password){
         saveString(USER,user);
         saveString(PAS,password);
    }
    public static User getAccout(){
        User user=new User();
        user.setUser(getString(USER,""));
        user.setPassword(getString(PAS,""));
        return user;
    }
